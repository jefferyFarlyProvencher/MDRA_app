            ...
            <View style={{flexDirection:"row", alignItems: "center", justifyContent: "center", backgroundColor:"#f7f7f7"}}>
                <View style={{width: Dimensions.get("window").width *0.8}}>
                    <SearchBar
                        ...
                        autoCorrect={false}
                        containerStyle={{backgroundColor:"#f7f7f7", borderTopWidth:0, borderBottomWidth:0, marginBottom:0, paddingBottom:0}}
                    />

                </View>
                <SelectorPicker choices={selectorChoices} itemSelected={this.handleItemSelected} style={{borderRadius:100, backgroundColor:"#949ca5"}} textStyle={{color:"#FFF"}}/>
            </View>
        );
    };
