...
var Slider = createReactClass({
    ...
    getInitialState() {
        ...
        return {
            pressedOne: true,
            value1: this.props.values[0],
            value2: this.props.values[1],
            value3: this.props.values[0],
            value4: this.props.values[1],
            value5: this.props.values[0],
            value6: this.props.values[1],
            past1: initialValues[0],
            past2: initialValues[1],
            past3: initialValues[0],
            past4: initialValues[1],
            past5: initialValues[0],
            past6: initialValues[1],
            position1: initialValues[0],
            position2: initialValues[1],
            position3: initialValues[0],
            position4: initialValues[1],
            position5: initialValues[0],
            position6: initialValues[1],
